...
from scripts.eval_and_rename_hf import _reeval_repo_ids
...
class _FakeApi:
    def list_models(self, *, author: str, search: str, token: str):
        ...
        assert search == "kibitzer-sft-elo-"
        assert token == "token"
        return [
            _ModelInfo("Pradheep1647/kibitzer-sft-elo-minus-0070-step-002000"),
...
def test_reeval_repo_ids_returns_legacy_and_pending_repos() -> None:
    assert _reeval_repo_ids(
        _FakeApi(),
        username="Pradheep1647",
        prefix="kibitzer-sft",
        token="token",
    ) == [
        "Pradheep1647/kibitzer-sft-elo-minus-0070-step-002000",
        "Pradheep1647/kibitzer-sft-elo-minus-0241-step-004000",
        "Pradheep1647/kibitzer-sft-elo-plus-0035-step-024000",
